...
![Coverage](https://img.shields.io/badge/coverage-20.7%25-red)
...
- **Shields.io バッジ**: `![Coverage](https://img.shields.io/badge/coverage-20.7%25-red)`
...
- データソース用MCP: 各種API（株価、経済指標）をMCPサーバとして統合
