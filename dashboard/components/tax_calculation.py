    ...
    def show_tax_calculation(self):
        ...
        with col1:
            ...
            with st.form("trade_form"):
                symbol = st.text_input("銘柄コード", value="", key="tax_calc_trade_symbol")
    ...
    def show_nisa_management(self):
        ...
        with col1:
            ...
            with st.form("nisa_form"):
                symbol = st.text_input("銘柄コード", value="", key="tax_calc_nisa_symbol")
    ...
    def show_profit_loss_simulation(self):
        ...
        with col1:
            ...
            with st.form("position_form"):
                symbol = st.text_input("銘柄コード", value="", key="tax_calc_profit_loss_symbol")
